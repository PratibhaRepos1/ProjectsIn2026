...
console.log(arrayFilter(integers));
...
let array_of_strings = ['3', '4', '8','9', '10'];
...
function trimArray(arr) {
    const trimArray = arr.slice(1,arr.length-1)
    return trimArray;
}

console.log(trimArray(numbers));
...
function findAverageGrade(obj) {
    ...
    let lists_of_subjects = Object.keys(obj);
    //console.log(lists_of_subjects)

    for(let i=0; i<lists_of_subjects.length; i++) {
        let current_key = lists_of_subjects[i];
